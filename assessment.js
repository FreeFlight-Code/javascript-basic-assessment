...
function removeItem (array, string){
 ...
 var arraynew = array.filter(function(e, i, array){
...
// the current time as a Date object  // new Date
...
function callerBack(callback, string){

  return callback(string + ' back')
